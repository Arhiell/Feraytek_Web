  ...
  function Profile({ usuario, onBackHome, onGoCart }){
    ...
    async function doSave(){
      ...
      try{
        ...
        if(Object.keys(payload).length===0){ setMsg({type:"ok",text:"No hay cambios para guardar"}); return; }
      ...
      React.createElement("div",{className:"profile"},
        ...
        React.createElement("div",{className:"profile-wrap"},
          React.createElement("div",{className:"profile-card"},
            ...
            React.createElement("div",{className:"card-block"},
              React.createElement("div",{className:"block-header"},
                React.createElement("h3",{className:"block-title"},"Información adicional"),
                React.createElement("p",{className:"block-sub"},"Campos opcionales para personalizar tu perfil.")
              ),
              React.createElement("div",{className:"block-divider"}),
              React.createElement("div",{className:"profile-grid grid two"},
                field("Bio","M12 6l8 4-8 4-8-4 8-4zm0 10l8 4-8-2-8 2 8-4z","bio"),
                field("Sitio web","M12 2a10 10 0 100 20 10 10 0 000-20z","sitio_web")
              )
            ),
